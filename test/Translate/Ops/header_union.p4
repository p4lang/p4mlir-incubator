...
// CHECK:           %[[VAL_1:.*]] = p4hir.struct_field_ref %[[VAL_0]]["h1"] : <!U>
// CHECK:           %[[VAL_2:.*]] = p4hir.struct_field_ref %[[VAL_1]]["__valid"] : <!H1>
...
// CHECK:           %[[VAL_0:.*]] = p4hir.variable ["u"] : <!U>
// CHECK:           %[[VAL_2:.*]] = p4hir.struct_field_ref %[[VAL_0]]["h2"] : <!U>
// CHECK:           %[[VAL_3:.*]] = p4hir.const #[[$ATTR_INVALID]]
// CHECK:           %[[VAL_4:.*]] = p4hir.struct_field_ref %[[VAL_2]]["__valid"] : <!H2>
// CHECK:           p4hir.assign %[[VAL_3]], %[[VAL_4]] : <!validity_bit>
// CHECK:           %[[VAL_1:.*]] = p4hir.struct_field_ref %[[VAL_0]]["h1"] : <!U>
// CHECK:           %[[VAL_5:.*]] = p4hir.const #[[$ATTR_VALID]]
// CHECK:           %[[VAL_6:.*]] = p4hir.struct_field_ref %[[VAL_1]]["__valid"] : <!H1>
...
// CHECK:           %[[VAL_0:.*]] = p4hir.variable ["u"] : <!U>
// CHECK:           %[[VAL_2:.*]] = p4hir.struct_field_ref %[[VAL_0]]["h1"] : <!U>
// CHECK:           %[[VAL_3:.*]] = p4hir.const #[[$ATTR_INVALID]]
// CHECK:           %[[VAL_4:.*]] = p4hir.struct_field_ref %[[VAL_2]]["__valid"] : <!H1>
// CHECK:           p4hir.assign %[[VAL_3]], %[[VAL_4]] : <!validity_bit>
// CHECK:           %[[VAL_5:.*]] = p4hir.struct_field_ref %[[VAL_0]]["h2"] : <!U>
// CHECK:           %[[VAL_6:.*]] = p4hir.const #[[$ATTR_INVALID]]
// CHECK:           %[[VAL_7:.*]] = p4hir.struct_field_ref %[[VAL_5]]["__valid"] : <!H2>
...
// CHECK:           %[[VAL_0:.*]] = p4hir.variable ["u"] : <!U>
// CHECK:           %[[VAL_1:.*]] = p4hir.variable ["h"] : <!H1>
// CHECK:           %[[VAL_3:.*]] = p4hir.struct_field_ref %[[VAL_0]]["h1"] : <!U>
// CHECK:           %[[VAL_4:.*]] = p4hir.const #[[$ATTR_INVALID]]
// CHECK:           %[[VAL_5:.*]] = p4hir.struct_field_ref %[[VAL_3]]["__valid"] : <!H1>
// CHECK:           p4hir.assign %[[VAL_4]], %[[VAL_5]] : <!validity_bit>
// CHECK:           %[[VAL_6:.*]] = p4hir.struct_field_ref %[[VAL_0]]["h2"] : <!U>
// CHECK:           %[[VAL_7:.*]] = p4hir.const #[[$ATTR_INVALID]]
// CHECK:           %[[VAL_8:.*]] = p4hir.struct_field_ref %[[VAL_6]]["__valid"] : <!H2>
// CHECK:           p4hir.assign %[[VAL_7]], %[[VAL_8]] : <!validity_bit>
// CHECK:           %[[VAL_2:.*]] = p4hir.struct_field_ref %[[VAL_0]]["h1"] : <!U>
// CHECK:           %[[VAL_9:.*]] = p4hir.read %[[VAL_1]] : <!H1>
// CHECK:           p4hir.assign %[[VAL_9]], %[[VAL_2]] : <!H1>
// CHECK:           p4hir.return
...
// CHECK:           %[[VAL_10:.*]] = p4hir.struct (%[[VAL_8]], %[[VAL_9]]) : !H1
// CHECK:           p4hir.assign %[[VAL_10]], %[[VAL_1]] : <!H1>
// CHECK:           p4hir.return
...
// CHECK:           %[[VAL_3:.*]] = p4hir.struct_field_ref %[[VAL_1]]["__valid"] : <!H1>
// CHECK:           p4hir.assign %[[VAL_2]], %[[VAL_3]] : <!validity_bit>
// CHECK:           %[[VAL_4:.*]] = p4hir.struct_field_ref %[[VAL_0]]["h2"] : <!U>
// CHECK:           %[[VAL_5:.*]] = p4hir.const #[[$ATTR_INVALID]]
// CHECK:           %[[VAL_6:.*]] = p4hir.struct_field_ref %[[VAL_4]]["__valid"] : <!H2>
// CHECK:           p4hir.assign %[[VAL_5]], %[[VAL_6]] : <!validity_bit>
// CHECK:           p4hir.return
...
// CHECK:           %[[VAL_0:.*]] = p4hir.variable ["u"] : <!U>
// CHECK:           %[[VAL_1:.*]] = p4hir.variable ["h2"] : <!H1>
// CHECK:           %[[VAL_2:.*]] = p4hir.read %[[VAL_0]] : <!U>
// CHECK:           %[[VAL_3:.*]] = p4hir.struct_extract %[[VAL_2]]["h1"] : !U
// CHECK:           p4hir.assign %[[VAL_3]], %[[VAL_1]] : <!H1>
// CHECK:           p4hir.return
...
// CHECK:           %[[VAL_4:.*]] = p4hir.cmp(eq, %[[VAL_2]] : !U, %[[VAL_3]] : !U)
...
// CHECK:           %[[VAL_2:.*]] = p4hir.read %[[VAL_0]] : <!U>
// CHECK:           %[[VAL_3:.*]] = p4hir.read %[[VAL_1]] : <!U>
// CHECK:           %[[VAL_4:.*]] = p4hir.cmp(ne, %[[VAL_2]] : !U, %[[VAL_3]] : !U)
// CHECK:           p4hir.if %[[VAL_4]]
