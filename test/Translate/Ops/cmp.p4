...
// CHECK:         %[[VAL_10:.*]] = p4hir.read %[[VAL_3]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_11:.*]] = p4hir.read %[[VAL_6]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_12:.*]] = p4hir.cmp(ne, %[[VAL_10]], %[[VAL_11]]) : !p4hir.bit<10>, !p4hir.bool
// CHECK:         p4hir.assign %[[VAL_12]], %[[VAL_0]] : <!p4hir.bool>
// CHECK:         %[[VAL_13:.*]] = p4hir.read %[[VAL_3]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_14:.*]] = p4hir.read %[[VAL_6]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_15:.*]] = p4hir.cmp(lt, %[[VAL_13]], %[[VAL_14]]) : !p4hir.bit<10>, !p4hir.bool
// CHECK:         p4hir.assign %[[VAL_15]], %[[VAL_0]] : <!p4hir.bool>
// CHECK:         %[[VAL_16:.*]] = p4hir.read %[[VAL_3]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_17:.*]] = p4hir.read %[[VAL_6]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_18:.*]] = p4hir.cmp(gt, %[[VAL_16]], %[[VAL_17]]) : !p4hir.bit<10>, !p4hir.bool
// CHECK:         p4hir.assign %[[VAL_18]], %[[VAL_0]] : <!p4hir.bool>
// CHECK:         %[[VAL_19:.*]] = p4hir.read %[[VAL_3]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_20:.*]] = p4hir.read %[[VAL_6]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_21:.*]] = p4hir.cmp(le, %[[VAL_19]], %[[VAL_20]]) : !p4hir.bit<10>, !p4hir.bool
// CHECK:         p4hir.assign %[[VAL_21]], %[[VAL_0]] : <!p4hir.bool>
// CHECK:         %[[VAL_22:.*]] = p4hir.read %[[VAL_3]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_23:.*]] = p4hir.read %[[VAL_6]] : <!p4hir.bit<10>>
