...
// CHECK:         p4hir.assign %[[VAL_7]], %[[VAL_0]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_8:.*]] = p4hir.read %[[VAL_3]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_9:.*]] = p4hir.read %[[VAL_6]] : <!p4hir.bit<10>>
// CHECK:         %[[VAL_10:.*]] = p4hir.binop(add, %[[VAL_8]], %[[VAL_9]]) : !p4hir.bit<10>
// CHECK:         p4hir.assign %[[VAL_10]], %[[VAL_0]] : <!p4hir.bit<10>>
