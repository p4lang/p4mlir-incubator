...
// CHECK-LABEL:   module
// CHECK-NEXT:    %[[VAL_0:.*]] = p4hir.const #[[$ATTR_14]]
// CHECK:         %[[VAL_1:.*]] = p4hir.const #[[$ATTR_0]]
// CHECK:         %[[VAL_2:.*]] = p4hir.const #[[$ATTR_1]]
// CHECK:         %[[VAL_3:.*]] = p4hir.const #[[$ATTR_13]]
// CHECK:         %[[VAL_4:.*]] = p4hir.const #[[$ATTR_20]]
// CHECK:         %[[VAL_5:.*]] = p4hir.const #[[$ATTR_4]]
// CHECK:         %[[VAL_6:.*]] = p4hir.const #[[$ATTR_20]]
// CHECK:         %[[VAL_7:.*]] = p4hir.const #[[$ATTR_15]]
// CHECK:         %[[VAL_8:.*]] = p4hir.const #[[$ATTR_22]]
// CHECK:         %[[VAL_9:.*]] = p4hir.const #[[$ATTR_24]]
// CHECK:         %[[VAL_10:.*]] = p4hir.const #[[$ATTR_22]]
// CHECK:         %[[VAL_11:.*]] = p4hir.const #[[$ATTR_23]]
// CHECK:         %[[VAL_12:.*]] = p4hir.const #[[$ATTR_14]]
// CHECK:         %[[VAL_13:.*]] = p4hir.const #[[$ATTR_4]]
// CHECK:         %[[VAL_14:.*]] = p4hir.const #[[$ATTR_17]]
// CHECK:         %[[VAL_15:.*]] = p4hir.const #[[$ATTR_26]]
// CHECK:         %[[VAL_16:.*]] = p4hir.const #[[$ATTR_28]]
// CHECK:         %[[VAL_17:.*]] = p4hir.const #[[$ATTR_27]]
// CHECK:         %[[VAL_18:.*]] = p4hir.const #[[$ATTR_7]]
// CHECK:         %[[VAL_19:.*]] = p4hir.const #[[$ATTR_10]]
// CHECK:         %[[VAL_20:.*]] = p4hir.const #[[$ATTR_5]]
// CHECK:         %[[VAL_21:.*]] = p4hir.const #[[$ATTR_8]]
// CHECK:         %[[VAL_22:.*]] = p4hir.const #[[$ATTR_10]]
// CHECK:         %[[VAL_23:.*]] = p4hir.const #[[$ATTR_18]]
// CHECK:         %[[VAL_24:.*]] = p4hir.const #[[$ATTR_9]]
// CHECK:         %[[VAL_25:.*]] = p4hir.const #[[$ATTR_12]]
// CHECK:         %[[VAL_26:.*]] = p4hir.const #[[$ATTR_2]]
// CHECK:         %[[VAL_27:.*]] = p4hir.const #[[$ATTR_3]]
// CHECK:         %[[VAL_28:.*]] = p4hir.const #[[$ATTR_19]]
// CHECK:         %[[VAL_29:.*]] = p4hir.const #[[$ATTR_21]]
// CHECK:         %[[VAL_30:.*]] = p4hir.const #[[$ATTR_18]]
// CHECK:         %[[VAL_31:.*]] = p4hir.const #[[$ATTR_21]]
// CHECK:         %[[VAL_32:.*]] = p4hir.const #[[$ATTR_25]]
// CHECK:         %[[VAL_33:.*]] = p4hir.const #[[$ATTR_19]]
// CHECK:         %[[VAL_34:.*]] = p4hir.const #[[$ATTR_3]]
// CHECK:         %[[VAL_35:.*]] = p4hir.const #[[$ATTR_2]]
// CHECK:         %[[VAL_36:.*]] = p4hir.const #[[$ATTR_9]]
// CHECK:         %[[VAL_37:.*]] = p4hir.const #[[$ATTR_18]]
// CHECK:         %[[VAL_38:.*]] = p4hir.const #[[$ATTR_18]]
// CHECK:         %[[VAL_39:.*]] = p4hir.const #[[$ATTR_9]]
// CHECK:         %[[VAL_40:.*]] = p4hir.const #[[$ATTR_12]]
// CHECK:         %[[VAL_41:.*]] = p4hir.const #[[$ATTR_2]]
// CHECK:         %[[VAL_42:.*]] = p4hir.const #[[$ATTR_3]]
// CHECK:         %[[VAL_43:.*]] = p4hir.const #[[$ATTR_19]]
// CHECK:         %[[VAL_44:.*]] = p4hir.const #[[$ATTR_21]]
// CHECK:         %[[VAL_45:.*]] = p4hir.const #[[$ATTR_18]]
// CHECK:         %[[VAL_46:.*]] = p4hir.const #[[$ATTR_21]]
// CHECK:         %[[VAL_47:.*]] = p4hir.const #[[$ATTR_25]]
// CHECK:         %[[VAL_48:.*]] = p4hir.const #[[$ATTR_19]]
// CHECK:         %[[VAL_49:.*]] = p4hir.const #[[$ATTR_3]]
// CHECK:         %[[VAL_50:.*]] = p4hir.const #[[$ATTR_2]]
// CHECK:         %[[VAL_51:.*]] = p4hir.const #[[$ATTR_9]]
// CHECK:         %[[VAL_52:.*]] = p4hir.const #[[$ATTR_18]]
// CHECK:         %[[VAL_53:.*]] = p4hir.const #[[$ATTR_16]]
// CHECK:         %[[VAL_54:.*]] = p4hir.const #[[$ATTR_6]]
// CHECK:         %[[VAL_55:.*]] = p4hir.const #[[$ATTR_11]]
// CHECK:         %[[VAL_56:.*]] = p4hir.const #[[$ATTR_16]]
