...
// CHECK:      p4hir.func @"$fv_rt1T_t1T"<![[type_T]]>(!p4hir.ref<![[type_T]]> {p4hir.dir = #out, p4hir.param_name = "hdr"})
// CHECK:      p4hir.func @"$fv_rt1Tiu32_t1T"<![[type_T]]>(!p4hir.ref<![[type_T]]> {p4hir.dir = #out, p4hir.param_name = "variableSizeHeader"}, !b32i {p4hir.dir = #in, p4hir.param_name = "variableFieldSizeInBits"})
// CHECK:    }
