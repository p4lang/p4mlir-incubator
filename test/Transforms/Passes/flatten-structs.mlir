...
// CHECK:           %[[VAL_0:.*]] = p4hir.struct_field_ref %[[ARG0]]["ingress_metadata_vrf"] : <!metadata>
// CHECK:           %[[VAL_1:.*]] = p4hir.struct_field_ref %[[ARG0]]["ingress_metadata_nexthop_index"] : <!metadata>
...
// CHECK:           %[[VAL_1:.*]] = p4hir.struct_extract %[[VAL_0]]["ingress_metadata_vrf"] : !metadata
// CHECK:           %[[VAL_2:.*]] = p4hir.struct_extract %[[VAL_0]]["ingress_metadata_nexthop_index"] : !metadata
...
// CHECK-SAME:      %[[ARG2:.*]]: !p4hir.ref<!b16i>) {
// CHECK:           %[[VAL_0:.*]] = p4hir.struct_field_ref %[[ARG0]]["ingress_metadata_vrf"] : <!metadata>
// CHECK:           %[[VAL_1:.*]] = p4hir.read %[[VAL_0]] : <!b16i>
// CHECK:           %[[VAL_2:.*]] = p4hir.struct_field_ref %[[ARG0]]["ingress_metadata_nexthop_index"] : <!metadata>
// CHECK:           %[[VAL_3:.*]] = p4hir.read %[[VAL_2]] : <!b16i>
...
// CHECK:           %[[VAL_0:.*]] = p4hir.struct_field_ref %[[ARG0]]["mirrored_md"] : <!parsed_packet_t>
// CHECK:           %[[VAL_1:.*]] = p4hir.const #[[$ATTR_5]]
// CHECK:           %[[VAL_2:.*]] = p4hir.struct_field_ref %[[VAL_0]]["__valid"] : <!serialized_switch_metadata_t>
// CHECK:           p4hir.assign %[[VAL_1]], %[[VAL_2]] : <!validity_bit>
// CHECK:           %[[VAL_3:.*]] = p4hir.struct_field_ref %[[ARG0]]["mirrored_md"] : <!parsed_packet_t>
// CHECK:           %[[VAL_4:.*]] = p4hir.struct_field_ref %[[VAL_3]]["meta_port2"] : <!serialized_switch_metadata_t>
// CHECK:           %[[VAL_5:.*]] = p4hir.struct_field_ref %[[VAL_3]]["meta_port1"] : <!serialized_switch_metadata_t>
// CHECK:           %[[VAL_6:.*]] = p4hir.const #[[$ATTR_3]]
