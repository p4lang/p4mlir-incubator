...
module @p4_main {
  ...
  p4hir.parser @callee1(%arg0: !b8i {p4hir.dir = #in, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir out>, p4hir.param_name = "ipv4"})() {
    p4hir.instantiate @p4_main::@Checksum8 () as @chk
    p4hir.state @start {
      %0 = p4hir.call_method @p4_main::@Checksum8::@get () of @chk : () -> !b8i
  ...
  p4hir.parser @callee2(%arg0: !b8i {p4hir.dir = #in, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir out>, p4hir.param_name = "ipv4"})() {
    ...
    p4hir.state @start {
      p4hir.scope {
        ...
        p4hir.apply @subparser1(%arg0, %ipv4_out_arg) : (!b8i, !p4hir.ref<!b8i>) -> ()
  ...
  // CHECK: p4hir.instantiate @p4_main::@Checksum8 () as @subparser2.subparser1.chk
  // CHECK: p4hir.instantiate @p4_main::@Checksum8 () as @subparser3.subparser1.chk
  // CHECK: %0 = p4hir.call_method @p4_main::@Checksum8::@get () of @subparser2.subparser1.chk : () -> !b8i
  ...
  p4hir.parser @caller(%arg0: !b8i {p4hir.dir = #in, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir out>, p4hir.param_name = "ipv4"})() {
    p4hir.instantiate @p4_main::@callee2 () as @subparser2
    p4hir.instantiate @p4_main::@callee2 () as @subparser3
    p4hir.state @start {
      p4hir.scope {
        %ipv4_out_arg = p4hir.variable ["ipv4_out_arg"] : <!b8i>
        p4hir.apply @subparser2(%arg0, %ipv4_out_arg) : (!b8i, !p4hir.ref<!b8i>) -> ()
