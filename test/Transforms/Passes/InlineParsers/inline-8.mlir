...
module @p4_main {
  ...
  p4hir.parser @callee(%arg0: !b8i {p4hir.dir = #p4hir<dir in>, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "ipv4"})(val: !b8i) {
    ...
    p4hir.instantiate @p4_main::@Checksum8 (%val : !b8i) as @chksum
    p4hir.state @start {
  ...
  p4hir.parser @calleeWrap(%arg0: !b8i {p4hir.dir = #p4hir<dir in>, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "ipv4"})(valPassthrough: !b8i) {
    ...
    // CHECK: p4hir.instantiate @p4_main::@Checksum8 (%valPassthrough : !b8i) as @wrap.chksum
    // CHECK-NOT: p4hir.instantiate @callee
    p4hir.instantiate @p4_main::@callee (%valPassthrough : !b8i) as @wrap
    p4hir.state @start {
      p4hir.scope {
        ...
        p4hir.apply @wrap(%arg0, %ipv4_inout_arg) : (!b8i, !p4hir.ref<!b8i>) -> ()
  ...
  p4hir.parser @caller(%arg0: !b8i {p4hir.dir = #p4hir<dir in>, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "ipv4"})() {
    ...
    p4hir.instantiate @p4_main::@calleeWrap (%c0_b8i : !b8i) as @inc1
    p4hir.instantiate @p4_main::@calleeWrap (%c1_b8i : !b8i) as @inc2
    p4hir.state @start {
      p4hir.scope {
        %ipv4_inout_arg = p4hir.variable ["ipv4_inout_arg", init] : <!b8i>
        %val = p4hir.read %arg1 : <!b8i>
        p4hir.assign %val, %ipv4_inout_arg : <!b8i>
        p4hir.apply @inc1(%arg0, %ipv4_inout_arg) : (!b8i, !p4hir.ref<!b8i>) -> ()
        %val_0 = p4hir.read %ipv4_inout_arg : <!b8i>
        p4hir.assign %val_0, %arg1 : <!b8i>
      }
      p4hir.scope {
        ...
        %val = p4hir.read %arg1 : <!b8i>
        p4hir.assign %val, %ipv4_inout_arg : <!b8i>
        p4hir.apply @inc2(%arg0, %ipv4_inout_arg) : (!b8i, !p4hir.ref<!b8i>) -> ()
        %val_0 = p4hir.read %ipv4_inout_arg : <!b8i>
        p4hir.assign %val_0, %arg1 : <!b8i>
      }
      p4hir.transition to @accept
  ...
  p4hir.parser @caller2(%arg0: !b8i {p4hir.dir = #p4hir<dir in>, p4hir.param_name = "packet"}, %arg1: !p4hir.ref<!b8i> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "ipv4"})() {
    ...
    // CHECK-DAG: p4hir.instantiate @p4_main::@Checksum8 (%[[CONST_0]] : !b8i) as @subparser.inc1.wrap.chksum
    // CHECK-DAG: p4hir.instantiate @p4_main::@Checksum8 (%[[CONST_1]] : !b8i) as @subparser.inc2.wrap.chksum
    // CHECK-NOT: p4hir.instantiate @caller
    p4hir.instantiate @p4_main::@caller () as @subparser
    p4hir.state @start {
      ...
      p4hir.scope {
        ...
        %val = p4hir.read %arg1 : <!b8i>
        p4hir.assign %val, %ipv4_inout_arg : <!b8i>
        p4hir.apply @subparser(%arg0, %ipv4_inout_arg) : (!b8i, !p4hir.ref<!b8i>) -> ()
        %val_0 = p4hir.read %ipv4_inout_arg : <!b8i>
        p4hir.assign %val_0, %arg1 : <!b8i>
      }
      p4hir.scope {
