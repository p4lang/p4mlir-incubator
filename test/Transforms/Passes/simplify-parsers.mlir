...
module {
  p4hir.parser @branching()() {
    ...
    p4hir.state @s1 {
      p4hir.transition to @s3
    }
    p4hir.state @s2 {
      p4hir.transition to @s3
    }
    p4hir.state @s3 {
      p4hir.transition to @s4
    }
    p4hir.state @s4 {
      p4hir.transition to @accept
    }
...
// CHECK:       p4hir.transition to @s1
// CHECK:       p4hir.state @s4
// CHECK:       p4hir.variable ["v4", init] : <!b8i>
// CHECK:       p4hir.transition to @s4
// CHECK:       p4hir.state @accept
module {
  p4hir.parser @cycles()() {
    p4hir.state @start {
