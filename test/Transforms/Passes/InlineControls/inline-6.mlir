...
module @p4_main {
  ...
  p4hir.control @c(%arg0: !p4hir.ref<!b32i> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "x"}, %arg1: !b32i {p4hir.dir = #p4hir<dir in>, p4hir.param_name = "y"})() {
    ...
    p4hir.instantiate @p4_main::@Y (%c10_b32i : !b32i) as @ext
    ...
    p4hir.func action @a2() {
      %__local_c_z_0 = p4hir.symbol_ref @__local_c_z_0 : !p4hir.ref<!b32i>
      %__local_c_z_0_0 = p4hir.symbol_ref @__local_c_z_0 : !p4hir.ref<!b32i>
      %val_1 = p4hir.read %__local_c_z_0_0 : <!b32i>
      %__local_c_y_0 = p4hir.symbol_ref @__local_c_y_0 : !b32i
    ...
    p4hir.control_apply {
      ...
      p4hir.switch (%action_run : !anon) {
        p4hir.case(anyof, [#anon_a1, #anon_a2]) {
          %0 = p4hir.call_method @p4_main::@Y::@get () of @ext : () -> !b32i
  ...
  p4hir.control @d(%arg0: !p4hir.ref<!b32i> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "x"})() {
    ...
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%c10_b32i : !b32i) as @cinst1.ext
    ...
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%c10_b32i : !b32i) as @cinst2.ext
    ...
    // CHECK:   %[[Z_VAR_1:.*]] = p4hir.symbol_ref @[[INST1_Z]] : !p4hir.ref<!b32i>
    // CHECK:   %[[Z_VAR_2:.*]] = p4hir.symbol_ref @[[INST1_Z]] : !p4hir.ref<!b32i>
    // CHECK:   %[[Z_VAL:.*]] = p4hir.read %[[Z_VAR_2]] : <!b32i>
    // CHECK:   %[[Y_VAR:.*]] = p4hir.symbol_ref @[[INST1_Y]] : !p4hir.ref<!b32i>
    ...
    // CHECK:   %[[Z_VAR_1:.*]] = p4hir.symbol_ref @[[INST2_Z]] : !p4hir.ref<!b32i>
    // CHECK:   %[[Z_VAR_2:.*]] = p4hir.symbol_ref @[[INST2_Z]] : !p4hir.ref<!b32i>
    // CHECK:   %[[Z_VAL:.*]] = p4hir.read %[[Z_VAR_2]] : <!b32i>
    ...
    p4hir.instantiate @p4_main::@c () as @cinst1
    p4hir.instantiate @p4_main::@c () as @cinst2

    // CHECK-LABEL: p4hir.control_apply
    p4hir.control_apply {
      // CHECK: %[[INST1_APPLY_TABLE_1:.*]] = p4hir.table_apply @cinst1.t with key() : () -> !t
      ...
      // CHECK: %[[INST1_APPLY_TABLE_2:.*]] = p4hir.table_apply @cinst1.t with key() : () -> !t
      ...
      // CHECK: %[[INST2_APPLY_TABLE_3:.*]] = p4hir.table_apply @cinst2.t with key() : () -> !t
      ...
      p4hir.scope {
        ...
        p4hir.apply @cinst1(%x_inout_arg, %c2_b32i) : (!p4hir.ref<!b32i>, !b32i) -> ()
      ...
      p4hir.if %ne {
        ...
        p4hir.scope {
          ...
          p4hir.apply @cinst1(%x_inout_arg, %c54_b32i) : (!p4hir.ref<!b32i>, !b32i) -> ()
        ...
        p4hir.scope {
          ...
          %val_2 = p4hir.read %arg0 : <!b32i>
          p4hir.assign %val_2, %x_inout_arg : <!b32i>
          p4hir.apply @cinst2(%x_inout_arg, %c50_b32i) : (!p4hir.ref<!b32i>, !b32i) -> ()
          %val_3 = p4hir.read %x_inout_arg : <!b32i>
          p4hir.assign %val_3, %arg0 : <!b32i>
        }
      }
