...
module @p4_main {
  ...
  p4hir.control @Callee1()() {
    ...
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%[[CONST_10]] : !b32i) as @ext
  ...
  p4hir.control @Callee2()() {
    // CHECK-DAG: %[[CONST_10:.*]] = p4hir.const #int10_b32i
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%[[CONST_10]] : !b32i) as @c1.ext
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%[[CONST_10]] : !b32i) as @c2.ext
    p4hir.instantiate @p4_main::@Callee1 () as @c1
    p4hir.instantiate @p4_main::@Callee1 () as @c2
    // CHECK:      p4hir.control_apply {
    // CHECK-NEXT: }
    p4hir.control_apply {
      p4hir.apply @c1() : () -> ()
  ...
  p4hir.control @Caller()() {
    // CHECK-DAG: %[[CONST_10:.*]] = p4hir.const #int10_b32i
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%[[CONST_10]] : !b32i) as @c1.ext
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%[[CONST_10]] : !b32i) as @c2a.c1.ext
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%[[CONST_10]] : !b32i) as @c2a.c2.ext
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%[[CONST_10]] : !b32i) as @c2b.c1.ext
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%[[CONST_10]] : !b32i) as @c2b.c2.ext
    p4hir.instantiate @p4_main::@Callee1 () as @c1
