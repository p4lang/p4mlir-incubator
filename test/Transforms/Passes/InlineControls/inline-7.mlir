...
module @p4_main {
  ...
  p4hir.control @Callee1(%arg0: !p4hir.ref<!b32i> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "x"})(val: !b32i) {
    ...
    p4hir.instantiate @p4_main::@Y (%val : !b32i) as @ext
    p4hir.control_apply {
      %0 = p4hir.call_method @p4_main::@Y::@get (%val) of @ext : (!b32i) -> !b32i
    }
  }
  ...
  p4hir.control @Callee2(%arg0: !p4hir.ref<!b32i> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "x"})() {
    ...
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%[[CONST_0]] : !b32i) as @c1.ext
    // CHECK-DAG: p4hir.instantiate @p4_main::@Y (%[[CONST_10]] : !b32i) as @c2.ext
    %c10_b32i = p4hir.const #int10_b32i
    %c0_b32i = p4hir.const #int0_b32i
    p4hir.control_local @__local_Callee2_x_0 = %arg0 : !p4hir.ref<!b32i>
    p4hir.instantiate @p4_main::@Callee1 (%c0_b32i : !b32i) as @c1
    p4hir.instantiate @p4_main::@Callee1 (%c10_b32i : !b32i) as @c2
    // CHECK: p4hir.control_apply
    p4hir.control_apply {
      // CHECK-DAG: %{{.*}} = p4hir.call_method @p4_main::@Y::@get (%[[CONST_0]]) of @c1.ext : (!b32i) -> !b32i
      // CHECK-DAG: %{{.*}} = p4hir.call_method @p4_main::@Y::@get (%[[CONST_10]]) of @c2.ext : (!b32i) -> !b32i
      p4hir.scope {
        %x_inout_arg = p4hir.variable ["x_inout_arg", init] : <!b32i>
        %val = p4hir.read %arg0 : <!b32i>
        p4hir.assign %val, %x_inout_arg : <!b32i>
        p4hir.apply @c1(%x_inout_arg) : (!p4hir.ref<!b32i>) -> ()
      ...
      p4hir.scope {
        ...
        %val = p4hir.read %arg0 : <!b32i>
        p4hir.assign %val, %x_inout_arg : <!b32i>
        p4hir.apply @c2(%x_inout_arg) : (!p4hir.ref<!b32i>) -> ()
        %val_0 = p4hir.read %x_inout_arg : <!b32i>
        p4hir.assign %val_0, %arg0 : <!b32i>
      }
    }
