...
module @p4_main {
  ...
  p4hir.control @Callee1(%arg0: !p4hir.ref<!b32i> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "x"})(val: !b32i) {
    ...
    p4hir.control_apply {
      %0 = p4hir.call_method @Y::@get (%val) of @ext : (!b32i) -> !b32i
    }
  }
  ...
  p4hir.control @Callee2(%arg0: !p4hir.ref<!b32i> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "x"})() {
    ...
    p4hir.control_apply {
      // CHECK-DAG: %{{.*}} = p4hir.call_method @Y::@get (%[[CONST_0]]) of @c1.ext : (!b32i) -> !b32i
      // CHECK-DAG: %{{.*}} = p4hir.call_method @Y::@get (%[[CONST_10]]) of @c2.ext : (!b32i) -> !b32i
      p4hir.scope {
