...
module {
  ...
  p4hir.parser @p1(%arg0: !p4hir.ref<!b32i>, %arg1: !p4hir.ref<!b32i>)() {
    ...
    // CHECK: p4hir.state @start_case0_pre
    // CHECK: p4hir.state @start_case0_then
    // CHECK: p4hir.transition to @p1::@start_case0_post
    // CHECK: p4hir.state @start_case0_else
    // CHECK: p4hir.transition to @p1::@start_case0_post
    // CHECK: p4hir.state @start_case0_post
    // CHECK: p4hir.transition to @p1::@start_post

    // Lowering of inner switch.
    // CHECK: p4hir.state @start_case1_pre
    // CHECK: %val = p4hir.read %arg0 : <!b32i>
    // CHECK: p4hir.transition_select %val : !b32i

    // Cases of inner switch.
    // CHECK: p4hir.state @start_case1_case0
    // CHECK: p4hir.state @start_case1_case1
    // CHECK: p4hir.state @start_case1_case2
    
    // CHECK: p4hir.state @start_case1_post
