...
module {
  ...
  // CHECK: p4hir.func @test_mul(%[[signed:.*]]: !i32i, %[[unsigned:.*]]: !b32i)
  p4hir.func @test_mul(%arg_i32i : !i32i, %arg_b32i : !b32i) {
  ...
  // CHECK: p4hir.func @test_div(%[[signed:.*]]: !i32i, %[[unsigned:.*]]: !b32i)
  p4hir.func @test_div(%arg_i32i : !i32i, %arg_b32i : !b32i) {
    // CHECK: p4hir.call @blackhole_i32i (%[[signed]])
    %res1 = p4hir.binop(div, %arg_i32i, %c1_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res1) : (!i32i) -> ()

    // CHECK: p4hir.call @blackhole_i32i (%[[c0_i32i]])
    %res2 = p4hir.binop(div, %c0_i32i, %arg_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res2) : (!i32i) -> ()

    // CHECK: p4hir.call @blackhole_b32i (%[[c0_b32i]])
    %res3 = p4hir.binop(div, %c0_b32i, %arg_b32i) : !b32i
    p4hir.call @blackhole_b32i(%res3) : (!b32i) -> ()
    p4hir.return
  }

  // CHECK: p4hir.func @test_mod(%[[signed:.*]]: !i32i, %[[unsigned:.*]]: !b32i)
  p4hir.func @test_mod(%arg_i32i : !i32i, %arg_b32i : !b32i) {
    // CHECK: p4hir.call @blackhole_i32i (%[[c0_i32i]])
    %res1 = p4hir.binop(mod, %arg_i32i, %c1_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res1) : (!i32i) -> ()

    // CHECK: p4hir.call @blackhole_i32i (%[[c0_i32i]])
    %res2 = p4hir.binop(mod, %c0_i32i, %arg_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res2) : (!i32i) -> ()
  ...
  // CHECK: p4hir.func @test_add(%[[signed:.*]]: !i32i, %[[unsigned:.*]]: !b32i)
  p4hir.func @test_add(%arg_i32i : !i32i, %arg_b32i : !b32i) {
    // CHECK: p4hir.call @blackhole_i32i (%[[signed]])
    ...
    // CHECK: p4hir.call @blackhole_i32i (%[[signed]])
    %res5 = p4hir.binop(sadd, %arg_i32i, %c0_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res5) : (!i32i) -> ()

    // CHECK: p4hir.call @blackhole_i32i (%[[signed]])
    %res6 = p4hir.binop(sadd, %c0_i32i, %arg_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res6) : (!i32i) -> ()

    // CHECK: p4hir.call @blackhole_i32i (%[[c15_i32i]])
    %res7 = p4hir.binop(sadd, %c5_i32i, %c10_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res7) : (!i32i) -> ()

    // CHECK: p4hir.call @blackhole_b32i (%[[unsigned]])
    %res8 = p4hir.binop(sadd, %arg_b32i, %c0_b32i) : !b32i
    p4hir.call @blackhole_b32i(%res8) : (!b32i) -> ()
    p4hir.return
  }

  // CHECK: p4hir.func @test_sub(%[[signed:.*]]: !i32i, %[[unsigned:.*]]: !b32i)
  p4hir.func @test_sub(%arg_i32i : !i32i, %arg_b32i : !b32i) {
    // CHECK: p4hir.call @blackhole_i32i (%[[signed]])
    %res1 = p4hir.binop(sub, %arg_i32i, %c0_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res1) : (!i32i) -> ()

    // CHECK: %[[minus:.*]] = p4hir.unary(minus, %[[signed]])
    // CHECK: p4hir.call @blackhole_i32i (%[[minus]])
    %res2 = p4hir.binop(sub, %c0_i32i, %arg_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res2) : (!i32i) -> ()

    // CHECK: p4hir.call @blackhole_b32i (%[[unsigned]])
    %res3 = p4hir.binop(sub, %arg_b32i, %c0_b32i) : !b32i
    p4hir.call @blackhole_b32i(%res3) : (!b32i) -> ()

    // CHECK: p4hir.call @blackhole_i32i (%[[signed]])
    %res4 = p4hir.binop(ssub, %arg_i32i, %c0_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res4) : (!i32i) -> ()

    // CHECK: %[[minus:.*]] = p4hir.unary(minus, %[[signed]])
    // CHECK: p4hir.call @blackhole_i32i (%[[minus]])
    %res5 = p4hir.binop(ssub, %c0_i32i, %arg_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res5) : (!i32i) -> ()

    // CHECK: p4hir.call @blackhole_b32i (%[[unsigned]])
    %res6 = p4hir.binop(sub, %arg_b32i, %c0_b32i) : !b32i
    p4hir.call @blackhole_b32i(%res6) : (!b32i) -> ()
    p4hir.return
  }

  // CHECK: p4hir.func @test_or(%[[signed:.*]]: !i32i, %[[unsigned:.*]]: !b32i)
  p4hir.func @test_or(%arg_i32i : !i32i, %arg_b32i : !b32i) {
    // CHECK: p4hir.call @blackhole_i32i (%[[c0_i32i]])
    %res1 = p4hir.binop(or, %c0_i32i, %arg_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res1) : (!i32i) -> ()

    // CHECK: p4hir.call @blackhole_b32i (%[[cones_b32i]])
    %res2 = p4hir.binop(or, %arg_b32i, %cones_b32i) : !b32i
    p4hir.call @blackhole_b32i(%res2) : (!b32i) -> ()
    p4hir.return
  }

  // CHECK: p4hir.func @test_and(%[[signed:.*]]: !i32i, %[[unsigned:.*]]: !b32i)
  p4hir.func @test_and(%arg_i32i : !i32i, %arg_b32i : !b32i) {
    // CHECK: p4hir.call @blackhole_b32i (%[[c0_b32i]])
    %res1 = p4hir.binop(and, %arg_b32i, %c0_b32i) : !b32i
    p4hir.call @blackhole_b32i(%res1) : (!b32i) -> ()

    // CHECK: p4hir.call @blackhole_b32i (%[[unsigned]])
    %res2 = p4hir.binop(and, %arg_b32i, %cones_b32i) : !b32i
    p4hir.call @blackhole_b32i(%res2) : (!b32i) -> ()

    // CHECK: p4hir.call @blackhole_i32i (%[[c0_i32i]])
    %res3 = p4hir.binop(and, %c5_i32i, %c10_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res3) : (!i32i) -> ()
    p4hir.return
  }

  // CHECK: p4hir.func @test_xor(%[[signed:.*]]: !i32i, %[[unsigned:.*]]: !b32i)
  p4hir.func @test_xor(%arg_i32i : !i32i, %arg_b32i : !b32i) {
    // CHECK: p4hir.call @blackhole_b32i (%[[unsigned]])
    %res1 = p4hir.binop(xor, %arg_b32i, %c0_b32i) : !b32i
    p4hir.call @blackhole_b32i(%res1) : (!b32i) -> ()

    // CHECK: p4hir.call @blackhole_b32i (%[[unsigned]])
    %res2 = p4hir.binop(xor, %c0_b32i, %arg_b32i) : !b32i
    p4hir.call @blackhole_b32i(%res2) : (!b32i) -> ()

    // CHECK: p4hir.call @blackhole_i32i (%[[c15_i32i]])
    %res3 = p4hir.binop(xor, %c5_i32i, %c10_i32i) : !i32i
    p4hir.call @blackhole_i32i(%res3) : (!i32i) -> ()
    p4hir.return
  }
