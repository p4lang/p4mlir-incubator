...
module {
  ...
  p4hir.parser @prs(%arg0: !packet_in {p4hir.dir = #p4hir<dir undir>, p4hir.param_name = "p"}, %arg1: !p4hir.ref<!Headers_t> {p4hir.dir = #out, p4hir.param_name = "headers"})() {
    p4hir.state @start {
      ...
      p4hir.call_method @packet_in::@extract<[!header_top]> (%arg0, %top_field_ref) : !packet_in, (!p4hir.ref<!header_top>) -> ()
      ...
      p4hir.call_method @packet_in::@advance (%arg0, %cast) : !packet_in, (!b32i) -> ()
      p4hir.transition to @prs::@parse_headers
    }
    p4hir.state @parse_headers {
      // CHECK: p4corelib.packet_lookahead
      %0 = p4hir.call_method @packet_in::@lookahead<[!b8i]> (%arg0) : !packet_in, () -> !b8i
    ...
    p4hir.state @parse_one {
      ...
      p4hir.call_method @packet_in::@extract<[!header_one]> (%arg0, %one_field_ref) : !packet_in, (!p4hir.ref<!header_one>) -> ()
      p4hir.transition to @prs::@parse_headers
    }
    p4hir.state @parse_two {
      %two_field_ref = p4hir.struct_extract_ref %arg1["two"] : <!Headers_t>
      p4hir.call_method @packet_in::@extract<[!header_two]> (%arg0, %two_field_ref) : !packet_in, (!p4hir.ref<!header_two>) -> ()
      p4hir.transition to @prs::@parse_headers
    }
    p4hir.state @parse_bottom {
      ...
      %1 = p4hir.call_method @packet_in::@length (%arg0) : !packet_in, () -> !b32i
      ...
      p4hir.call_method @packet_in::@extract<[!header_bottom]> (%arg0, %bottom_field_ref, %cast_0) : !packet_in, (!p4hir.ref<!header_bottom>, !b32i) -> ()
