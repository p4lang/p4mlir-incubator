...
// Check that we don't convert if checks on table_apply hit/miss to bmv2ir.if
...
module {
  ...
  p4hir.parser @parser(%arg0: !p4corelib.packet_in {p4hir.dir = #undir, p4hir.param_name = "pkt"}, %arg1: !p4hir.ref<!Headers> {p4hir.dir = #out, p4hir.param_name = "h"}, %arg2: !p4hir.ref<!Meta> {p4hir.dir = #inout, p4hir.param_name = "meta"}, %arg3: !p4hir.ref<!standard_metadata_t> {p4hir.dir = #inout, p4hir.param_name = "stdmeta"})() {
    p4hir.state @start {
  ...
  p4hir.control @vrfy(%arg0: !p4hir.ref<!Headers> {p4hir.dir = #inout, p4hir.param_name = "h"}, %arg1: !p4hir.ref<!Meta> {p4hir.dir = #inout, p4hir.param_name = "meta"})() {
    p4hir.control_apply {
    }
  }
  p4hir.control @ingress(%arg0: !p4hir.ref<!Headers> {p4hir.dir = #inout, p4hir.param_name = "hdr"}, %arg1: !p4hir.ref<!Meta> {p4hir.dir = #inout, p4hir.param_name = "m"}, %arg2: !p4hir.ref<!standard_metadata_t> {p4hir.dir = #inout, p4hir.param_name = "s"})() {
    ...
    p4hir.func action @setb1(%arg3: !b8i {p4hir.annotations = {name = "b1"}, p4hir.dir = #undir, p4hir.param_name = "b1_1"}) annotations {name = "ingress.setb1"} {
    ...
    p4hir.func action @setb2(%arg3: !b8i {p4hir.annotations = {name = "b2"}, p4hir.dir = #undir, p4hir.param_name = "b2_1"}) annotations {name = "ingress.setb2"} {
      %Headers_data = bmv2ir.symbol_ref @Headers_data : !p4hir.ref<!data_t>
      %b2_field_ref = p4hir.struct_field_ref %Headers_data["b2"] : <!data_t>
      p4hir.assign %arg3, %b2_field_ref : <!b8i>
      p4hir.return
    }
    p4hir.func action @setb3(%arg3: !b8i {p4hir.annotations = {name = "b3"}, p4hir.dir = #undir, p4hir.param_name = "b3_1"}) annotations {name = "ingress.setb3"} {
      %Headers_data = bmv2ir.symbol_ref @Headers_data : !p4hir.ref<!data_t>
    ...
    p4hir.table @t1_0 annotations {name = "ingress.t1"} {
      p4hir.table_key(%arg3: !p4hir.ref<!Headers>) {
        %Headers_data = bmv2ir.symbol_ref @Headers_data : !p4hir.ref<!data_t>
        %val = p4hir.read %Headers_data : <!data_t>
        %r1 = p4hir.struct_extract %val["r1"] : !data_t
    ...
    p4hir.table @t2_0 annotations {name = "ingress.t2"} {
      p4hir.table_key(%arg3: !p4hir.ref<!Headers>) {
        %Headers_data = bmv2ir.symbol_ref @Headers_data : !p4hir.ref<!data_t>
        %val = p4hir.read %Headers_data : <!data_t>
        %r2 = p4hir.struct_extract %val["r2"] : !data_t
    ...
    p4hir.table @t3_0 annotations {name = "ingress.t3"} {
      p4hir.table_key(%arg3: !p4hir.ref<!Headers>) {
        %Headers_data = bmv2ir.symbol_ref @Headers_data : !p4hir.ref<!data_t>
        %val = p4hir.read %Headers_data : <!data_t>
        %b1 = p4hir.struct_extract %val["b1"] : !data_t
        p4hir.match_key #exact %b1 : !b8i annotations {name = "hdr.data.b1"}
        %Headers_data_0 = bmv2ir.symbol_ref @Headers_data : !p4hir.ref<!data_t>
        %val_1 = p4hir.read %Headers_data_0 : <!data_t>
        %b2 = p4hir.struct_extract %val_1["b2"] : !data_t
        p4hir.match_key #exact %b2 : !b8i annotations {name = "hdr.data.b2"}
      }
      p4hir.table_actions {
...
// CHECK:      bmv2ir.if @cond_node_0 expr {
// CHECK:      } then {
// CHECK:        %[[APPLY:.*]] = p4hir.table_apply @ingress::@t1_0
// CHECK:        %[[MISS:.*]] = p4hir.struct_extract %[[APPLY]]["miss"]
// CHECK:        p4hir.if %[[MISS]] {
// CHECK:          %{{.*}} = p4hir.table_apply @ingress::@t2_0
// CHECK:        }
// CHECK:        %{{.*}} = p4hir.table_apply @ingress::@t3_0 with key(%arg0) : (!p4hir.ref<!Headers>) -> !t3_0
// CHECK:      } else {
// CHECK:      }
    p4hir.control_apply {
      %Headers_data = bmv2ir.symbol_ref @Headers_data : !p4hir.ref<!data_t>
      %val = p4hir.read %Headers_data : <!data_t>
      %c1 = p4hir.struct_extract %val["c1"] : !data_t
  ...
  p4hir.control @egress(%arg0: !p4hir.ref<!Headers> {p4hir.dir = #inout, p4hir.param_name = "h"}, %arg1: !p4hir.ref<!Meta> {p4hir.dir = #inout, p4hir.param_name = "m"}, %arg2: !p4hir.ref<!standard_metadata_t> {p4hir.dir = #inout, p4hir.param_name = "s"})() {
    p4hir.control_apply {
    }
  }
