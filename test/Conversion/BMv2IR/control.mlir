...
module {
  ...
  bmv2ir.header_instance @HU1.h2 : !p4hir.ref<!H2>
  bmv2ir.header_union_instance @HU1 : !HU1 headers [@HU1.h1, @HU1.h2]
  bmv2ir.header_instance @headers_eth_hdr : !p4hir.ref<!ethernet_t>
  p4hir.parser @parser(%arg0: !p4corelib.packet_in {p4hir.dir = #undir, p4hir.param_name = "pkt"}, %arg1: !p4hir.ref<!headers> {p4hir.dir = #out, p4hir.param_name = "hdr"}, %arg2: !p4hir.ref<!Meta> {p4hir.dir = #inout, p4hir.param_name = "m"}, %arg3: !p4hir.ref<!standard_metadata_t> {p4hir.dir = #inout, p4hir.param_name = "sm"})() {
    p4hir.state @start {
...
// CHECK-LABEL: bmv2ir.table @dummy_table_0
// CHECK: next_tables [#bmv2ir.action_table<@ingress::@dummy_action_0 : @ingress::@dummy_table_1>]
// CHECK-LABEL:    bmv2ir.table @dummy_table_1
// CHECK:     next_tables [#bmv2ir.action_table<@ingress::@dummy_action_4 : @ingress::@cond_node_1>]
// CHECK-LABEL:   bmv2ir.table @dummy_table_2
// CHECK:     next_tables [#bmv2ir.action_table<@ingress::@dummy_action_1 : @ingress::@cond_node_2>]
// CHECK-LABEL:    bmv2ir.table @dummy_table_3
// CHECK:     next_tables [#bmv2ir.action_table<@ingress::@dummy_action_2>]
// CHECK-LABEL:    bmv2ir.table @dummy_table_4
// CHECK:     next_tables [#bmv2ir.action_table<@ingress::@dummy_action_3>]
// CHECK:    bmv2ir.conditional @cond_node_0 then @ingress::@dummy_table_1 else @ingress::@dummy_table_0
// CHECK:    bmv2ir.conditional @cond_node_1 then @ingress::@dummy_table_2 else @ingress::@cond_node_2
// CHECK:    bmv2ir.conditional @cond_node_2 then @ingress::@dummy_table_3 else @ingress::@dummy_table_4
  p4hir.control @ingress(%arg0: !p4hir.ref<!headers> {p4hir.dir = #inout, p4hir.param_name = "h"}, %arg1: !p4hir.ref<!Meta> {p4hir.dir = #inout, p4hir.param_name = "m"}, %arg2: !p4hir.ref<!standard_metadata_t> {p4hir.dir = #inout, p4hir.param_name = "sm"})() {
    p4hir.func action @dummy_action_4() annotations {name = "dummy_action_4"} {
      p4hir.return
    }
    p4hir.func action @dummy_action_3() annotations {name = "dummy_action_3"} {
      p4hir.return
    }
    p4hir.func action @dummy_action_2() annotations {name = "dummy_action_2"} {
      p4hir.return
    }
    p4hir.func action @dummy_action_1() annotations {name = "dummy_action_1"} {
      p4hir.return
    }
    p4hir.func action @dummy_action_0() annotations {name = "dummy_action_0"} {
      p4hir.return
    ...
    p4hir.table @dummy_table_1 {
      p4hir.table_action @dummy_action_4() {
        p4hir.call @ingress::@dummy_action_4 () : () -> ()
      }
      p4hir.table_default_action {
        p4hir.call @ingress::@dummy_action_4 () : () -> ()
      }
    ...
    p4hir.table @dummy_table_2 {
      p4hir.table_action @dummy_action_1() {
    ...
    p4hir.table @dummy_table_3 {
      p4hir.table_action @dummy_action_2() {
    ...
    p4hir.table @dummy_table_4 {
      p4hir.table_action @dummy_action_3() {
        p4hir.call @ingress::@dummy_action_3 () : () -> ()
      }
      p4hir.table_default_action {
        p4hir.call @ingress::@dummy_action_3 () : () -> ()
      }
    ...
    p4hir.control_apply {
      bmv2ir.if @cond_node_0 expr {
        %headers_eth_hdr = bmv2ir.symbol_ref @headers_eth_hdr : !p4hir.ref<!ethernet_t>
        %__valid_field_ref = p4hir.struct_field_ref %headers_eth_hdr["__valid"] : <!ethernet_t>
        %val = p4hir.read %__valid_field_ref : <!validity_bit>
        %valid_0 = p4hir.const #valid
        %eq = p4hir.cmp(eq, %val : !validity_bit, %valid_0 : !validity_bit)
        bmv2ir.yield %eq : !p4hir.bool
      } then {
      } else {
        %dummy_table_0_apply_result = p4hir.table_apply @ingress::@dummy_table_0 with key() : () -> !dummy_apply_res
      }
      %dummy_table_1_apply_result = p4hir.table_apply @ingress::@dummy_table_1 with key() : () -> !dummy_apply_res
      bmv2ir.if @cond_node_1 expr {
        %HU1.h2 = bmv2ir.symbol_ref @HU1.h2 : !p4hir.ref<!H2>
        %__valid_field_ref = p4hir.struct_field_ref %HU1.h2["__valid"] : <!H2>
        %val = p4hir.read %__valid_field_ref : <!validity_bit>
        %valid_0 = p4hir.const #valid
        %eq = p4hir.cmp(eq, %val : !validity_bit, %valid_0 : !validity_bit)
        bmv2ir.yield %eq : !p4hir.bool
      } then {
        %dummy_table_2_apply_result = p4hir.table_apply @ingress::@dummy_table_2 with key() : () -> !dummy_apply_res
      } else {
      }
      bmv2ir.if @cond_node_2 expr {
        %headers_eth_hdr = bmv2ir.symbol_ref @headers_eth_hdr : !p4hir.ref<!ethernet_t>
        %index_field_ref = p4hir.struct_field_ref %headers_eth_hdr["index"] : <!ethernet_t>
        %val = p4hir.read %index_field_ref : <!b32i>
        %c5_b32i_0 = p4hir.const #int5_b32i
        %gt = p4hir.cmp(gt, %val : !b32i, %c5_b32i_0 : !b32i)
        bmv2ir.yield %gt : !p4hir.bool
      } then {
        %dummy_table_3_apply_result = p4hir.table_apply @ingress::@dummy_table_3 with key() : () -> !dummy_apply_res
      } else {
        %dummy_table_4_apply_result = p4hir.table_apply @ingress::@dummy_table_4 with key() : () -> !dummy_apply_res
      }
    }
  }
  p4hir.control @vrfy(%arg0: !p4hir.ref<!headers> {p4hir.dir = #inout, p4hir.param_name = "h"}, %arg1: !p4hir.ref<!Meta> {p4hir.dir = #inout, p4hir.param_name = "m"})() {
